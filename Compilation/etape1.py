...
def interpreteur(PCODE):
    ...
    while PS!="END":
        ...
        elif INST=="EQL": ##laisse 1 au sommet de pile si sous-sommet = sommet, 0 sinon (idem pour NEQ, GTR, LSS, GEQ, LEQ)
        ...
        elif INST=="INT": ##incrémente de la constante c le pointeur de pile (la constante c peut être négative)
            MEM+=[0]*OPERANDE
            SP+=OPERANDE
        ...
        elif INST=="LDV": ##remplace le sommet par la valeur trouvée à l'adresse indiquée par le sommet (déréférence)
            MEM[-1]=MEM[MEM[-1]]
...
PCODE = [("LDI",3),("LDI",2),("ADD",False),("PRN",False),("HLT",False)]
